...
系统首次启动时会自动初始化以下演示账号，可直接用于登录测试：

| 角色 | 登录入口 | 用户名/学号 | 密码 | 备注 |
| ---- | -------- | ----------- | ---- | ---- |
| 教师 | 登录界面 | `t_zhang` | `demo_hash_teacher` | 张老师 |
| 学生 | 登录界面 | `2452001` | `demo_hash_student` | 李娜（含完整演示数据） |
| 学生 | 登录界面 | `2452002` | `demo_hash_student` | 王强 |
| 管理员 | 登录界面 | `admin` | `admin123` | 管理员 |
