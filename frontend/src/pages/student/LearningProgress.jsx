                ...
                {learnStats.weekReport.length === 0 ? (
                  ...
                  <table className="w-full">
                    <thead className="bg-gray-50 dark:bg-gray-900">
                      <tr>
                        <th className="text-left px-6 py-3 text-sm font-medium text-gray-500 dark:text-gray-400">星期</th>
                        <th className="text-left px-6 py-3 text-sm font-medium text-gray-500 dark:text-gray-400">学习时长（小时）</th>
                        <th className="text-left px-6 py-3 text-sm font-medium text-gray-500 dark:text-gray-400">学习内容</th>
                      </tr>
                    </thead>
