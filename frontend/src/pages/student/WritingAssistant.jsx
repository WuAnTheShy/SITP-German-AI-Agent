      ...
      <div className="student-page">
        ...
        <div className="student-card p-6 mb-6">
          <textarea
            ...
            className="student-input w-full p-4 rounded-lg resize-y placeholder-gray-400 dark:placeholder-gray-500 disabled:bg-gray-50 dark:disabled:bg-gray-800/70"
          />
        ...
        {correctionResult && (
          <div className="student-card p-6 mb-6">
            ...
            <div className="mb-4">
              <h4 className="font-semibold text-gray-700 dark:text-gray-300 mb-2">发现的问题：</h4>
              <div className="space-y-2">
                {correctionResult.errors.map((err, index) => (
                  <div key={index} className="flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/25 rounded-lg border border-red-100 dark:border-red-800/50">
                    <span className="px-2 py-1 bg-red-100 dark:bg-red-900/50 text-red-700 dark:text-red-300 text-xs rounded font-mono shrink-0">{err.position}</span>
                    <span className="text-red-600 dark:text-red-300">{err.error}</span>
                    <span className="text-green-700 dark:text-green-300 ml-auto shrink-0">→ {err.suggestion}</span>
                  </div>
                ))}
              </div>
            </div>
