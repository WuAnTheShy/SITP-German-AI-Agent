                        ...
                        <div className="animate-fade-in-up">
                            ...
                            <div className="flex gap-3">
                                ...
                                <div className="relative group cursor-pointer" onClick={refreshCaptcha}>
                                    <img src={captcha.dataUrl || null} alt="Captcha" className="h-[44px] w-[108px] sm:h-[46px] sm:w-[120px] rounded-xl border border-gray-200 dark:border-white/10 object-cover" />
